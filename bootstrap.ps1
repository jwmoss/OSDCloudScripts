...
<unattend xmlns="urn:schemas-microsoft-com:unattend">
    ...
    <cpi:offlineImage cpi:source="wim:c:/users/jonathan.moss/documents/iso/win1122h2/sources/install.wim#Windows 11 Enterprise" xmlns:cpi="urn:schemas-microsoft-com:cpi" />
</unattend>
"@
